...
class HerokuContext:
    ...
    def backup_svc(self, car_offer_dao: carscanner.dao.CarOfferDao, data_path: pathlib.Path, backup_remote: str) \
            -> carscanner.service.GitBackupService:
        return carscanner.service.GitBackupService(car_offer_dao, data_path, backup_remote)
